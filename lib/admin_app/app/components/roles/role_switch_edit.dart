...
class RolesSwitchEdit extends StatefulWidget {
  var responseData;
  ...
  @override
  _RolesSwitchEditState createState() => _RolesSwitchEditState();
}

class _RolesSwitchEditState extends State<RolesSwitchEdit> {
...
//                    margin: EdgeInsets.only(top: 10,bottom: 10,left: 10,right: 10),
  ...
  void _validateAndSubmit() async {
    if (formkey.currentState.validate()) {
      ...
      var roleId = widget.responseData.toString().split("??")[1];
      print(roleId);
...
//      }
      ...
      var response = await _apiService.updateRole(roleData, roleId);
          ...
          return new CupertinoAlertDialog(
            ...
            actions: [
              ...
              CupertinoDialogAction(
                ...
                onPressed: () {
                  RoleRepo.deleteContact(args: value);
