...
class AuditHistoryUser extends StatefulWidget {
  @override
  _AuditHistoryUserState createState() => _AuditHistoryUserState();
}

class _AuditHistoryUserState extends State<AuditHistoryUser> {
...
//          centerTitle: true,
        ...
        body: AsyncLoader(
          ...
          renderSuccess: ({data}) => auditLogUser(data, provider),
        ));
  }

  auditLogUser(data, provider) {
    print(data);
    ...
    if (data == null) {
      ...
      return Container(
        child: Center(
          child: Text("Unable to retrive Information\nNo Data found :(",
